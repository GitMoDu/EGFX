...
//		using BitmaskFontColorSourceType = Framework::Shader::Source::SingleColor<dimension_t>;
//
//		template<typename dimension_t>
//		using BitmaskFontPixelShaderType = Framework::Shader::Pixel::TemplateShader<dimension_t, BitmaskFontColorSourceType<dimension_t>>;
//
//		template<typename dimension_t>
//		using BitmaskFontPrimitiveShaderType = Framework::Shader::Primitive::TemplateShader<dimension_t, BitmaskFontPixelShaderType<dimension_t>>;
//
...
//
//			using dimension_t = typename Framework::AutoDimension::BySize<(ScaleDimension * ScaleX), (ScaleDimension * ScaleY)>::dimension_t;
//
//			// Single color, bitmask scaled font drawer type.
//			using BitmaskFontDrawerType = Framework::Bitmask::Font::TemplateDrawer<BitmaskFontType, ScaleX, ScaleY, BitmaskFontPrimitiveShaderType<dimension_t>>;
//
...
//		{
//			using dimension_t = typename Framework::AutoDimension::BySize<ParentLayout::Width(), ParentLayout::Height()>::dimension_t;
//
//			// Single color bitmask font drawer type.
//			using BitmaskFontDrawerType = Framework::Bitmask::Font::TemplateDrawer<BitmaskFontType, 1, 1, BitmaskFontPrimitiveShaderType<dimension_t>>;
//
//			// Bitmask text drawer type with all the template parameters set.
//			using BitmaskTextDrawerType = Framework::Text::TemplateWriter<ParentLayout, BitmaskFontDrawerType>;
//		};
