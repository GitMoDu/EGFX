...
using DisplayConfig = IntegerGlass::PlatformPresets::Configs::ARDUINO_I2C_DEFAULT;
...
//using ScreenDriverType = IntegerGlass::ScreenDriverSSD1331_96x64x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET>;
//using ScreenDriverType = IntegerGlass::ScreenDriverSSD1351_128x128x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2>;
//using ScreenDriverType = IntegerGlass::ScreenDriverST7735S_80x160x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET>;
//using ScreenDriverType = IntegerGlass::ScreenDriverST7735S_160x128x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2>;
...
//using ScreenDriverType = IntegerGlass::ScreenDriverST7789_240x240x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2>;
...
//using ScreenDriverType = IntegerGlass::ScreenDriverGC9107_128x128x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET>;
//using ScreenDriverType = IntegerGlass::ScreenDriverGC9A01_240x240x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET>;
