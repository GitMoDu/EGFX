...
//using DisplayConfig = IntegerGlass::PlatformPresets::Configs::RP2350_SPI_LCD_1_47_INCH;
using DisplayConfig = IntegerGlass::PlatformPresets::Configs::RP2350_WAVESHARE_SPI_LCD_TOUCH_2_INCH;
...
using IntegerGlassOptions = IntegerGlass::DisplayOptions::TemplateOptions<
	...
	IntegerGlass::DisplayOptions::RotationEnum::Rotate90,
	false
>;
...
//using ScreenDriverType = IntegerGlass::ScreenDriverSSD1306_128x64x1_SPI<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2>;
using ScreenDriverType = IntegerGlass::ScreenDriverSH1106_128x64x1_SPI<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2>;
...
//using ScreenDriverType = IntegerGlass::ScreenDriverSSD1331_96x64x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2>;
...
//using ScreenDriverType = IntegerGlass::ScreenDriverST7789_172x320x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2>;
//using ScreenDriverType = IntegerGlass::ScreenDriverST7789_240x240x16_SPI<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET>;
using ScreenDriverType = IntegerGlass::ScreenDriverST7789T3_240x320x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2, 15>;
...
//using ScreenDriverType = IntegerGlass::ScreenDriverGC9A01_240x240x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2>;
