...
//using ScreenDriverType = IntegerGlass::ScreenDriverST7789_172x320x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, 80000000, 10>;
...
//using ScreenDriverType = IntegerGlass::ScreenDriverST7789T3_240x320x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2, 18>;
