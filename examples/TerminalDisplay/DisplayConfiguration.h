...
//using DisplayConfig = Egfx::PlatformPresets::Configs::ARDUINO_SPI_GENERIC;
...
//using DisplayConfig = Egfx::PlatformPresets::Configs::RP2350_SPI_LCD_1_47_INCH;
using DisplayConfig = Egfx::PlatformPresets::Configs::RP2350_WAVESHARE_SPI_LCD_TOUCH_2_INCH;
...
//using ScreenDriverType = Egfx::ScreenDriverSSD1306_128x64x1_SPI<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2>;
...
//using ScreenDriverType = Egfx::ScreenDriverST7789_172x320x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, 80000000, 10>;
//using ScreenDriverType = Egfx::ScreenDriverST7789_240x240x16_SPI<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET>;
//using ScreenDriverType = Egfx::ScreenDriverST7789T3_240x320x16_SPI_Dma<DisplayConfig::CS, DisplayConfig::DC, DisplayConfig::RESET, F_CPU / 2, 18>;
