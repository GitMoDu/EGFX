...
namespace Egfx
{
	...
	class Color32FramePainter : public AbstractFramePainter<ColorConverter32, frameWidth, frameHeight, rotated>
	{
	private:
		using Base = AbstractFramePainter<ColorConverter32, frameWidth, frameHeight, rotated>;
