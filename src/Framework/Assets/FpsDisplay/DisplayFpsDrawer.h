//#ifndef _EGFX_FRAMEWORK_ASSETS_DISPLAY_FPS_h
//#define _EGFX_FRAMEWORK_ASSETS_DISPLAY_FPS_h
//
...
//	};
//
//	namespace DisplayFpsDrawerDetails
//	{
//		//constexpr char LabelText[] = " FPS";
...
//			, LabelWidth(TextDrawer.GetTextWidth(DisplayFpsDrawerDetails::LabelText))
...
//				TextDrawer.Write(frame, Layout::X() + valueWidth + SpaceWidth, Layout::Y(), reinterpret_cast<const char*>(DisplayFpsDrawerDetails::LabelText));
//				break;
//			case FpsDrawerPosition::TopRight:
//				TextDrawer.Write(frame, Layout::X() + Layout::Width() - LabelWidth, Layout::Y(), reinterpret_cast<const char*>(DisplayFpsDrawerDetails::LabelText));
...
//				TextDrawer.Write(frame, Layout::X() + valueWidth + SpaceWidth, Layout::Y() + Layout::Height() - TextDrawer.GetFontHeight(), reinterpret_cast<const char*>(DisplayFpsDrawerDetails::LabelText));
//				break;
//			case FpsDrawerPosition::BottomRight:
//				TextDrawer.Write(frame, Layout::X() + Layout::Width() - LabelWidth, Layout::Y() + Layout::Height() - TextDrawer.GetFontHeight(), reinterpret_cast<const char*>(DisplayFpsDrawerDetails::LabelText));
