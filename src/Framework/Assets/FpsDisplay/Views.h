#ifndef _EGFX_FRAMEWORK_ASSETS_FPS_DISPLAY_VIEWS_h
#define _EGFX_FRAMEWORK_ASSETS_FPS_DISPLAY_VIEWS_h
		...
		namespace Assets
		{
			namespace FpsDisplay
			{
				namespace Views
				{
					...
					class FpsText : public View::AbstractView
					{
					public:
						using DrawableType = Drawables::FpsText<Layout, FontDrawerType, fpsDrawerPosition>;
					...
					template<
						typename Layout,
						typename... ViewTypes>
					class CompositeWithFps : public View::CompositeView<
						ViewTypes...,
						FpsText<Layout>>
					{
					private:
						using FpsViewType = FpsText<Layout>;
						using Base = View::CompositeView<ViewTypes..., FpsViewType>;
