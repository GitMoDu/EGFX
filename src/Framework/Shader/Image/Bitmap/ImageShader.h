#ifndef _INTEGERGLASS_FRAMEWORK_SHADER_IMAGE_BITMAP_IMAGE_SHADER_h
#define _INTEGERGLASS_FRAMEWORK_SHADER_IMAGE_BITMAP_IMAGE_SHADER_h
	...
	namespace Framework
	{
		namespace Shader
		{
			namespace Image
			{
				namespace Bitmap
				{
					// Template selector for Scaled vs Unscaled bitmap shaders based on ScaleX and ScaleY.
					...
					using ImageShader = typename IntegerSignal::TypeTraits::TypeConditional::conditional_type<
						Scaled<dimension_t, color_t, ScaleX, ScaleY, DataSourceType, UseTransparency, TransparentColor, TransformOrder, ColorShaderType, TransformShaderType, BlendMode>,
						Unscaled<dimension_t, color_t, DataSourceType, UseTransparency, TransparentColor, ColorShaderType, TransformShaderType, BlendMode>,
