		...
		namespace Text
		{
			namespace Vector
			{
				...
				class TextView : public Framework::View::DrawablesView<ParentLayout,
					Drawable::Text<dimension_t, ParentLayout, FontType, GlyphStyle, ColorShaderType, TransformShaderType, PaletteType>>
				{
				private:
					using DrawableType = Drawable::Text<dimension_t, ParentLayout, FontType, GlyphStyle, ColorShaderType, TransformShaderType, PaletteType>;
