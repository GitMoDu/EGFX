...
#ifndef _SCREEN_SSD1331_h
#define _SCREEN_SSD1331_h
...
#endif
		DriverSpi.setColor(RGB_COLOR8(color.r, color.g, color.b));
...
template<const uint8_t spiChannel,
	...
	const uint8_t pinDC,
	const uint8_t pinRST>
class ScreenSSD1331_96_64 : public ScreenSSD1331_X_X<spiChannel, pinCS, pinDC, pinRST, 96, 64>
{
public:
	ScreenSSD1331_96_64()
		: ScreenSSD1331_X_X<spiChannel, pinCS, pinDC, pinRST, 96, 64>()
	{}
};
#endif