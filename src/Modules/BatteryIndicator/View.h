#ifndef _INTEGERGLASS_MODULES_BATTERY_INDICATOR_VIEW_h
#define _INTEGERGLASS_MODULES_BATTERY_INDICATOR_VIEW_h
	...
	namespace Modules
	{
		namespace BatteryIndicator
		{
			template<typename dimension_t,
				...
				typename OutsideColorShaderType = Framework::Shader::Color::NoShader<dimension_t>,
				typename OutsideTransformShaderType = Framework::Shader::Transform::NoTransform<dimension_t>,
