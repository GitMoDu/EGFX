#ifndef _INTEGERGLASS_MODULES_KIT_ANIMATION_INTERPOLATOR_ANTICIPATE_OVERSHOOT_h
#define _INTEGERGLASS_MODULES_KIT_ANIMATION_INTERPOLATOR_ANTICIPATE_OVERSHOOT_h
