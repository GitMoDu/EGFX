...
namespace ST7735
{
	...
	struct ST7735S
	{
		...
		static constexpr bool InvertColors = false;
		static constexpr uint8_t Madctl = 0x68;
	};

	struct ST7735S_160x128
	{
		static constexpr uint8_t Width = 160;
		static constexpr uint8_t Height = 128;

		static constexpr uint8_t XOffset = 0;
		static constexpr uint8_t YOffset = 0;

		static constexpr bool InvertColors = true;
		static constexpr uint8_t Madctl = 0x60;
	};

	static constexpr uint16_t RESET_DELAY_MICROS = 1000;
	static constexpr uint8_t RESET_WAIT_MICROS = 10;

	static constexpr uint32_t SpiMaxSpeed = 33333333;
