...
class AbstractScreenDriverSH1106_SPI : public AbstractScreenDriverSPI<GraphicsBuffer::GetMonochromeBufferSize(width, height), width, height, pinCS, pinDC, pinRST>
{
private:
